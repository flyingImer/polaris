 ...
 * {@linkplain PolarisCredential credentials}.
 *
...
public interface Authenticator {
  ...
  /**
   * Authenticates the given {@link PolarisCredential} and returns an authenticated {@link
   * PolarisPrincipal}.
   *
  ...
  PolarisPrincipal authenticate(PolarisCredential credentials)
      throws NotAuthorizedException, ServiceFailureException;
}
