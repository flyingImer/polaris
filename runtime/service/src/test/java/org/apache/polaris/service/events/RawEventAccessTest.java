...
@QuarkusTest
@TestProfile(RawEventAccessTest.Profile.class)
class RawEventAccessTest {

  public static class Profile implements QuarkusTestProfile {
    @Override
    public Map<String, String> getConfigOverrides() {
      return ImmutableMap.of("polaris.event-listener.types", "raw-access-test-listener");
    }
  }

  @Singleton
  @Identifier("raw-access-test-listener")
  public static class RawAccessTestListener implements PolarisEventListener, RawEventAccess {
  ...
  @Test
  void shouldDeliverRawEventBypassingSanitizer() {
    var testListener = (RawAccessTestListener) listener;

    Catalog sensitiveCatalog = mock(Catalog.class);
    when(sensitiveCatalog.getName()).thenReturn("raw-catalog");
